...
\begin{enumerate}
  \item $2x^2 -16x+24=0$\\[15mm]
  \item $125x^3 -27=0$\\[15mm]
\end{enumerate}
      
      \item Si $f$ es una funci\'{o}n tal que $f(x+2)=x^2-6$. Calcule $f(4)$.\\[25mm]
      
      \item Determine el dominio de la siguiente funci\'{o}n: $y=\sqrt{\displaystyle\frac{5x-1}{3x-2}}$.\\[45mm]
      
      \item Halle el recorrido de la funci\'{o}n $y=\displaystyle\frac{2}{x^2+5x-14}$, si $x\in [-3; 1]$.\\[40mm]
      
%       \item Para las siguientes funciones:
%       \[
%       f(x)= \frac{five[[1]][1]}{x^2five[[1]][2]xfive[[1]][3]}
%       \qquad 
%       g(x)= \frac{five[[2]][1]}{\sqrt{five[[2]][2]x}}
%       \]
%       Calcule $f$o$g$.
